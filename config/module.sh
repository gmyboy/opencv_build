...
export COMMON_CV_CFG_FLAGS="$COMMON_CV_CFG_FLAGS -DBUILD_ANDROID_EXAMPLES=ON"
...
export COMMON_CV_CFG_FLAGS="$COMMON_CV_CFG_FLAGS -DBUILD_EXAMPLES=ON"
export COMMON_CV_CFG_FLAGS="$COMMON_CV_CFG_FLAGS -DBUILD_PACKAGE=ON"
...
export COMMON_CV_CFG_FLAGS="$COMMON_CV_CFG_FLAGS -DWITH_WIN32UI=OFF"
