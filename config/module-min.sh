...
export COMMON_CV_CFG_FLAGS="$COMMON_CV_CFG_FLAGS -DBUILD_opencv_calib3d=OFF"
...
export COMMON_CV_CFG_FLAGS="$COMMON_CV_CFG_FLAGS -DBUILD_opencv_dnn=OFF"
export COMMON_CV_CFG_FLAGS="$COMMON_CV_CFG_FLAGS -DBUILD_opencv_dpm=OFF"
export COMMON_CV_CFG_FLAGS="$COMMON_CV_CFG_FLAGS -DBUILD_opencv_features2d=OFF"
export COMMON_CV_CFG_FLAGS="$COMMON_CV_CFG_FLAGS -DBUILD_opencv_flann=OFF"
...
export COMMON_CV_CFG_FLAGS="$COMMON_CV_CFG_FLAGS -DBUILD_opencv_highgui=OFF"
export COMMON_CV_CFG_FLAGS="$COMMON_CV_CFG_FLAGS -DBUILD_opencv_imgcodecs=OFF"
export COMMON_CV_CFG_FLAGS="$COMMON_CV_CFG_FLAGS -DBUILD_opencv_imgproc=OFF"
export COMMON_CV_CFG_FLAGS="$COMMON_CV_CFG_FLAGS -DBUILD_opencv_ittnotify=OFF"
export COMMON_CV_CFG_FLAGS="$COMMON_CV_CFG_FLAGS -DBUILD_opencv_java=OFF"
export COMMON_CV_CFG_FLAGS="$COMMON_CV_CFG_FLAGS -DBUILD_opencv_java_bindings_generator=OFF"
export COMMON_CV_CFG_FLAGS="$COMMON_CV_CFG_FLAGS -DBUILD_opencv_ml=OFF"
export COMMON_CV_CFG_FLAGS="$COMMON_CV_CFG_FLAGS -DBUILD_opencv_objdetect=OFF"
export COMMON_CV_CFG_FLAGS="$COMMON_CV_CFG_FLAGS -DBUILD_opencv_photo=OFF"
...
export COMMON_CV_CFG_FLAGS="$COMMON_CV_CFG_FLAGS -DBUILD_opencv_tracking=OFF"
export COMMON_CV_CFG_FLAGS="$COMMON_CV_CFG_FLAGS -DBUILD_opencv_video=OFF"
export COMMON_CV_CFG_FLAGS="$COMMON_CV_CFG_FLAGS -DBUILD_opencv_videoio=OFF"
export COMMON_CV_CFG_FLAGS="$COMMON_CV_CFG_FLAGS -DBUILD_opencv_videostab=OFF"
export COMMON_CV_CFG_FLAGS="$COMMON_CV_CFG_FLAGS -DBUILD_opencv_world=OFF"
...
export COMMON_CV_CFG_FLAGS="$COMMON_CV_CFG_FLAGS -DBUILD_TBB=OFF"
...
export COMMON_CV_CFG_FLAGS="$COMMON_CV_CFG_FLAGS -DWITH_GTK=OFF"
...
export COMMON_CV_CFG_FLAGS="$COMMON_CV_CFG_FLAGS -DWITH_OPENMP=OFF"
...
export COMMON_CV_CFG_FLAGS="$COMMON_CV_CFG_FLAGS -DWITH_TBB=OFF"
